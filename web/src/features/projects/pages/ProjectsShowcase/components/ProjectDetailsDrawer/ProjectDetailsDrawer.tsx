...
import { MilestonesTab } from '@/features/projects/pages/ProjectsShowcase/components/ProjectDetailsDrawer/tabs/Milestones/MilestonesTab'
import { MilestoneFormDrawer } from '@/features/projects/pages/ProjectsShowcase/components/ProjectDetailsDrawer/tabs/Milestones/MilestoneFormDrawer'
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <label className="block">
                      <span className="text-xs font-semibold text-zinc-700 dark:text-zinc-300 block mb-1">Pobrana gwarancja, %</span>
                      <input
                        type="number"
                        min="0"
                        step="0.01"
                        value={formState.warrantyPercent ?? ''}
                        onChange={(e) => setField('warrantyPercent', e.target.value ? Number(e.target.value) : undefined)}
                        placeholder="Np. 5.5"
                        className="h-10 w-full rounded-xl border border-[var(--border)] bg-[var(--background)] px-3 text-sm outline-none transition duration-150 ease-in-out placeholder:text-zinc-500/70 dark:placeholder:text-zinc-400/70 focus:border-[var(--sidebar-primary)] focus:ring-2 focus:ring-[var(--sidebar-primary)]/15 hover:border-zinc-400/60 dark:hover:border-zinc-600/60 disabled:opacity-50"
                      />
                    </label>
