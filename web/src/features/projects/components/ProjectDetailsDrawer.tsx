...
type ProjectDetailsDrawerProps = {
  ...
  createMutation: UseMutationResult<any, Error, CreateProjectPayload, unknown>
  updateMutation: UseMutationResult<any, Error, { id: string; payload: Partial<CreateProjectPayload> }, unknown>
